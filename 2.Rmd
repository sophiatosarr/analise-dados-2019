...
#### 1- A identificação de outliers nas variáveis quantidade e preço revelou algumas transações incomuns. Esses outliers podem indicar promoções, produtos premium  ou erros de registro.

#### 2- Uma forte correlação linear positiva foi observada entre preço e custo dos produtos, indicando que produtos mais caros tendem a ter custos mais altos.

#### 3- A maioria dos produtos é vendida a preços mais baixos. 